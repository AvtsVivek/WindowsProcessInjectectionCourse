...
namespace ClassicInjectWithDll
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            var processFileName = "powershell"; // Change the process if you like.
            ...
            //        hProcess = OpenProcess(0x001F0FFF, false, processID);
                    ...
                    UInt64 dllnumber = UInt64.Parse(dllAddress, System.Globalization.NumberStyles.HexNumber); // String -> Int
