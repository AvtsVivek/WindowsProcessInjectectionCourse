...
namespace LowLevelWinApiMapViewOfSection
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //IntPtr localBaseAddress = new();
            //int sizeLocal = 4096;
            //ulong offsetSectionLocal = new();
            ...
            //IntPtr remoteBaseAddress = new();
            //int sizeRemote = 4096;
            //ulong offsetSectionRemote = new();
